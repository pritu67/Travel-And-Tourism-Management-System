...
public class Dashboard extends JFrame implements ActionListener {
    String username;
        JButton addPersonalDetails,viewPersonalDetails,updatePersonalDetails,checkPackages,bookPackage,viewPackage,viewhotels,destinations,bookhotel,viewBookedHotel,payments,calculators;
JButton notepad,about,deletePersonalDetails;
    Dashboard(String username){
       ...
       // setBounds(0,0,1600,1000);
        ...
        bookhotel.addActionListener(this);
         ...
         viewBookedHotel=new JButton("View Bookd Hotel");
